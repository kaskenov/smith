...
description: >-
  ...
  CLI, or mentions --name, --template, --path, --force, or --skip flags.
---
# Smith replicate
...
Returns `{ written: string[], skipped: string[] }` listing output paths.
...
3. File tree replication (placeholder substitution)
